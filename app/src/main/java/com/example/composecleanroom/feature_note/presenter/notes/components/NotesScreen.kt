...
import com.example.composecleanroom.feature_note.presenter.notes.viewModel.NoteViewModel
...
fun NotesScreen(navController: NavController,viewModel:NoteViewModel = hiltViewModel()) {
    ...
    , scaffoldState = scaffoldState) {
      ...
      Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.SpaceBetween, verticalAlignment = Alignment.CenterVertically) {
          Text(text = "Ваши заметки", style = MaterialTheme.typography.h4)
          IconButton(onClick = { 
      ...
      AnimatedVisibility(
          ...
          OrderSection(modifier = Modifier
              ...
              .testTag(ORDER_SECTION), noteOrder = state.noteOrder, onOrderChange = {
